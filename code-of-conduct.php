<?php include 'includes/header.inc.php'; ?>
	...
	<section class="container-fluid code-of-conduct-main-div">
		<section class="row code-of-conduct-row">
			<section class="col-md-2"></section>
			<section class="col-md-8">

				<section>
					<h5 class="text-center text-white div-title">Code Of Conduct</h5>
					<p>
                        GDG University of Cape Coast is a chapter of the larger Google Developer community, as such we follow and enforce the <a href="https://developers.google.com/groups/guidelines/" style="text-transform: uppercase"> Google Developer Community Guidelines</a>.
				...
				<section>
					<h5 class="text-center text-white div-title">Don't be a Jerk <i class="fa fa-smile-o"></i></h5>
					<p>
                        GDG University Of Cape Coast prides itself on being an open, respectful, and inclusive community.
			            That means jerky behavior isn't allowed at GDG meetings. Because we know that it's not obvious to
			            everyone, here's a reminder of things we don't allow: jokes or offensive comments about
			            sex/sexuality/race/religion/nationality/body size, showing porn in public, touching people uninvited,
			            or continuing to interact with someone after they've asked you to stop. Continuous jerky behavior may
			            result in getting expelled from the meeting or GDG Chapter.
			            <br><br>
			            If someone is bothering you, please tell the GDG Organizers or event host and they will take care of it.
			            We want to maintain GDG University Of Cape Coast's awesomeness.
                    </p>
				</section><br><br>

				<section>
					<h5 class="text-center text-white div-title">Anti-Harassment Policy</h5>
					<p>
						Why do we have an official Anti-Harassment policy for GDG University Of Cape Coast events?
                    </p>
                    <ul>
	                    <li>
	                ...
	                <p>
						GDG University Of Cape Coast is dedicated to providing a harassment-free event experience for everyone, regardless of:
                    </p>
                    <ul>
		                <li>Gender</li>
				...
				<section>
					<h5 class="text-center text-white div-title">Values</h5>
					<p>
                        GDG University Of Cape Coast is an inclusive community where developers, designers, and entrepreneurs of all skill levels, genders, religions, and backgrounds are welcome to learn, practice, and share Google technologies, services, and platforms. Our motto is “Be excellent to each other;” if you see or experience anything different please contact
            			<a href="#!/organizers" style="text-transform: uppercase">our organizers.</a>
                    </p>
				</section>
